...
namespace AE::Math
{
	...
	public:
		...
		ND_ static Self  RotateY (Rad_t angle)				{ return Self{ glm::rotate( Identity()._value, T(angle), Vec3_t{0.0f, 1.0f, 0.0f} )}; }
...
*/
	...
	inline Quat<T>  Quat<T>::FromDirection (const Vec3_t &dir, const Vec3_t &up)
	{
		...
		return Self{glm::quat_cast( glm::mat3x3{ hor, ver, dir })};
	}
