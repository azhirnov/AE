...
*/
	struct PixelFormatInfo
	{
		...
		PixelFormatInfo (EPixelFormat fmt, uint bpp, EType type, EImageAspect aspect = EImageAspect::Color) :
			format{fmt}, bitsPerBlock{bpp}, aspectMask{aspect}, valueType{type} {}

		PixelFormatInfo (EPixelFormat fmt, uint bpp, const uint2 &size, EType type, EImageAspect aspect = EImageAspect::Color) :
			format{fmt}, bitsPerBlock{bpp}, aspectMask{aspect}, valueType{type}, blockSize{size} {}

		PixelFormatInfo (EPixelFormat fmt, uint depthBPP, uint stencilBPP, EType type = EType::DepthStencil, EImageAspect aspect = EImageAspect::DepthStencil) :
